...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { languages: @search.languages, name: @search.name } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { languages: @search.languages, name: @search.name } }
