...
module InputGroup
  ...
  def custom_append(wrapper_options = nil)
    custom_tag = options[:custom_append]
    template.content_tag(:div, custom_tag, class: "input-group-append")
  end
end
